 ...
 *
 * @author yinian
 * @since 2023-06-08 06:14:01
 */
public interface OmsOrderDao1 {
     ...
     * @return 对象列表
     */
    List<OmsOrder> queryAllByLimit(@Param("omsOrder")OmsOrder omsOrder, @Param("pageable") Pageable pageable);
